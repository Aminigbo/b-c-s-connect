...
import {Fellowships } from '../../utilities/data';
...
function SelectFellowship({ route, appState, disp_surprise }) {
                            ...
                            Fellowships.map((e, key) => {
                                return <Pressable
                                    ...
                                    onPress={async () => {
                                        ...
                                        await AsyncStorage.setItem("AUTHFELLOWSHIP", JSON.stringify(e))
                                        setPick(key)
                                    }}
                                    style={{
                                        // // display: "flex",
...
export default connect(mapStateToProps, mapDispatchToProps)(SelectFellowship);
